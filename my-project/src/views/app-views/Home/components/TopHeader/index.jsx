        ...
        <div>
          <nav>
            <ul>
              ...
              <li className='separator-top-menu'>|</li>
              {user?.username || user?.payload?.username ? (
                <div className='inline-flex justify-center'>
                  ...
                  >
                    Hi, {user.username ? user.username : user.payload.username}
                    <CiLogout className='text-xl' onClick={() => dispatch(clearStore('Logging out...'))}/>
                  </button>
                  {/* <div
                    className={
